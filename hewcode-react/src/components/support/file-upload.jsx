...
const FileUpload = ({
  ...
  const defaultPlaceholder = __('hewcode::hewcode.file_upload.click_to_upload_or_drag_and_drop');
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="text-white text-center">
                    ...
                    <p className="text-sm">{__('hewcode::hewcode.file_upload.click_or_drag_to_replace')}</p>
                  </div>
                </div>
              </div>
            ) : (
        ...
        <>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">{placeholder || defaultPlaceholder}</p>
